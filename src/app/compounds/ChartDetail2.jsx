...
const ChartDetail2 = () => {
    ...
    const {dataClientes,currentMonthFilter, setCurrentMonthFilter,currentYearFilter, setCurrentYearFilter, busqueda, setBusqueda, dataEmpleados, dataEquipos, dataZonas, dataCiudades, currentGroupFilter, setCurrentGroupFilter, dataVisitasSeguimientos, dataVisitasRealizadas, visitasMes, setVisitasMes, visitasAnual, setVisitasAnual, visitasDia, setVisitasDia, visitasHistorico, setVisitasHistorico} = useContext(ChartsContext)
        ...
        switch (currentGroupFilter) {
            case '0':
                if(!busqueda){
                    ...
                    basedDataa = dataClientes //FILTRO DE BUSQUEDA
                }
                break;
                    ...
                    <div className="resultsCont">
                        {basedData.map( data =>(
                            <Result 
                                ...
                                text={`${data.CLI_NOMBRE} (${data.CLI_NIT})`} 
                                key={data.CIU_ID}
                            />
                        ))}
                    </div>
